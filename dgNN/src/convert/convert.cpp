...
std::vector<std::vector<std::vector<torch::Tensor>>> csr2ell(int num_rows, int num_cols, torch::Tensor indptr,
                                                             torch::Tensor indices, int num_col_parts,
                                                             std::vector<int> buckets)
{
    ...
    return BucketPartHyb(
        num_rows, num_cols, indptr, indices, num_col_parts, buckets);
}
