...
do
    python -u dgNN/script/test/test_gf.py --dim $dim --heads $heads --batch-size $bs  | tee log/day_${day}/gf_${dim}_${heads}_${bs}_${comment}_${Time}.log
    # python -u dgNN/script/test/test_gf_ell.py --dim $dim --heads $heads --batch-size $bs  | tee log/day_${day}/gf_ell_${dim}_${heads}_${bs}_${comment}_${Time}.log
